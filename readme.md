<p align="center">
<img width="120" src="https://raw.githubusercontent.com/martineastwood/featuristic/main/docs/assets/dna.svg" alt="Featuristic DNA logo" />
</p>
...
<div align="center">
  ...
  [![Python versions](https://img.shields.io/pypi/pyversions/featuristic)](https://pypi.org/project/featuristic/)
  [![CI](https://github.com/martineastwood/featuristic/actions/workflows/ci.yml/badge.svg?branch=main)](https://github.com/martineastwood/featuristic/actions/workflows/ci.yml)
  [![License: MIT](https://img.shields.io/badge/license-MIT-yellow.svg)](LICENSE.txt)
  [![Built with Nuwa](https://img.shields.io/badge/built%20with-Nuwa-00A98F)](https://github.com/martineastwood/nuwa-build)
...
Next, Featuristic scores those formulas. **By default** it uses Pearson correlation with the target, computed in the compiled Nim backend. Formulas yielding features with the strongest correlations are selected and recombined by the genetic algorithm to produce offspring.

To minimize a different loss (MAE, pinball, …), pass `fitness_function` to `GeneticFeatureSynthesis`. See [Metrics](docs/guide/metrics.md#synthesis-geneticfeaturesynthesis).
...
This iterative process continues across multiple generations, continually refining the population of formulas. The default objective is strong correlation with the target; a custom `fitness_function` uses the same evolutionary loop with your scalar instead.
...
The default fitness is Pearson correlation in Nim. To minimize MAE (or another loss) instead:
